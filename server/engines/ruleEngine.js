...
const SCENARIOS = [
  {
    ...
    image_keyword: 'cozy bedroom rest',
    place_keyword: 'home'
  },
  {
    ...
    image_keyword: 'cozy sofa watching tv',
    place_keyword: 'home'
  },
  {
    ...
    image_keyword: 'cozy cafe interior rainy',
    place_keyword: 'cafe'
  },
  {
    ...
    image_keyword: 'sunny park running outdoor',
    place_keyword: 'park'
  },
  {
    ...
    image_keyword: 'home cooking kitchen',
    place_keyword: 'home'
  },
  {
    ...
    image_keyword: 'fine dining restaurant interior',
    place_keyword: 'restaurant'
  },
  {
    ...
    image_keyword: 'coffee cafe latte',
    place_keyword: 'cafe'
  },
  {
    ...
    image_keyword: 'hot chocolate cozy winter home',
    place_keyword: 'home'
  },
  {
    ...
    image_keyword: 'museum art gallery interior',
    place_keyword: 'museum'
  },
  {
    ...
    image_keyword: 'board game cafe friends',
    place_keyword: 'cafe'
  },
  {
    ...
    image_keyword: 'studying laptop desk',
    place_keyword: 'library'
  },
  {
    ...
    image_keyword: 'picnic park sunny grass',
    place_keyword: 'park'
  }
];
...
function scoreScenario(input, scenario) {
  ...
  for (const key of keys) {
    ...
    else return 0; // 하나라도 불일치하면 제외 (0 = 매칭 안 됨)
  }
  return score; // 1 이상이면 매칭
}
...
async function recommend(input) {
  ...
  return {
    ...
    image_keyword: bestScenario.image_keyword || bestScenario.keyword || bestScenario.recommendation,
    place_keyword: bestScenario.place_keyword || null
  };
}
